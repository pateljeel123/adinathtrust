...
const ChakraWithParticles = () => {
  ...
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(ellipse at center, #0a0e1a 0%, #0f172a 70%, #1e293b 100%)",
    ...
    >
      ...
      <div
        className={`absolute z-10 ${
          isMobile
            ? "w-[300px] h-[300px] border-[20px]"
            : isTablet
            ? "w-[450px] h-[450px] border-[30px]"
            : "w-[600px] h-[600px] border-[40px]"
        } border-yellow-400/20 rounded-full blur-xl animate-pulse`}
      ></div>
      <div
        className={`absolute z-10 ${
          isMobile
            ? "w-[400px] h-[400px] border-[10px]"
            : isTablet
            ? "w-[600px] h-[600px] border-[15px]"
            : "w-[800px] h-[800px] border-[20px]"
        } border-blue-400/15 rounded-full blur-lg animate-pulse`}
        style={{ animationDelay: "1.5s" }}
      ></div>
      <div
        className={`absolute z-10 ${
          isMobile
            ? "w-[200px] h-[200px] border-[15px]"
            : isTablet
            ? "w-[300px] h-[300px] border-[20px]"
            : "w-[400px] h-[400px] border-[30px]"
        } border-purple-400/10 rounded-full blur-md animate-pulse`}
      ...
      <div
        className={`absolute z-15 ${
          isMobile
            ...
            ? "w-[350px] h-[350px]"
            : "w-[500px] h-[500px]"
        } rounded-full bg-gradient-radial from-yellow-300/30 via-transparent to-transparent blur-[150px] opacity-40 animate-pulse-slow`}
      ></div>
      ...
      <div
        className={`relative z-20 ${
          isSmallMobile
            ? "w-[290px] h-[290px] mt-10"
            : isMobile
            ? "w-[320px] h-[320px] mt-8"
            : isTablet
            ? "w-[450px] h-[450px] mt-4"
            : "w-[600px] h-[600px] mt-20"
        }`}
      >
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          <img
            ...
            className={`w-full h-full object-contain spin-anticlockwise-animation ${
              isChakraLoaded ? "opacity-95" : "opacity-0"
            }`}
            style={{
              filter:
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <img
            ...
            alt="Murti"
            loading="lazy"
            className={`object-contain gentle-pulse-animation ${
              isSmallMobile
                ? "w-[85%] h-[85%]"
                : isMobile
                ? "w-[80%] h-[80%]"
            ...
            style={{
              filter:
                "drop-shadow(0 0 40px rgba(255, 255, 255, 0.7)) brightness(1.1)",
            }}
          />
        </div>
      </div>
      ...
      <div
        ...
        } left-0 right-0 z-30 text-center px-4`}
      >
        <div className="inline-block bg-black/40 backdrop-blur-md rounded-xl px-3 sm:px-6 py-2 sm:py-3 border border-yellow-500/40 shadow-lg hover:shadow-yellow-500/20 transition-all duration-500 hover:scale-[1.02] relative">
          <p
            className={`text-yellow-300 ${
              isSmallMobile
                ...
                ? "text-base"
                : "text-xl md:text-2xl"
            } font-sanskrit leading-relaxed tracking-wider ${
          ...
          <div
            className={`absolute bottom-1 right-3 text-yellow-200/90 ${
              isSmallMobile ? "text-xs" : "text-sm md:text-base"
            } font-light tracking-wider italic after:content-[''] after:absolute after:-bottom-1 after:right-0 after:w-8 after:h-px after:bg-yellow-500/50`}
          >
            - aadinath dada
          </div>
        </div>
          ...
          return (
            <img
              ...
              style={{
                ...
                top: `${Math.random() * 100}%`,
                width: `${
                  isMobile ? 1.5 + Math.random() * 2 : 2 + Math.random() * 4
                }rem`,
                height: "auto",
                opacity: 0.4,
